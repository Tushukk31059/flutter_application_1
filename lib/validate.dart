...
class _StudentFormPageState extends State<StudentFormPage> {
  ...
  // 🔹 UPDATED addStudent() — now calls registerStudent() instead of insertNote()
  void addStudent() async {
    ...
    if (_branch == null ||
        ...
        _duration == null ||
        _startDate == null) {
      Fluttertoast.showToast(msg: "Please select all selections");
      return;
    }
    ...
    // ✅ Call registerStudent() from DatabaseHelper
     dbHelper.registerStudent(
      _nameCtrl.text, // studentName
      _emailCtrl.text, // eMail
      int.parse(_mobileCtrl.text), // contact
      _pwdCtrl.text, // password
      _branch!, // branch
      _course!, // course
      _subCourse!, // subCategory
      _type!, // typeOfCourse
      _duration!, // duration
      _startDate.toString(), // date (convert DateTime → string)
  ...
  // 2. 🔴 MODIFIED: _submit method to include Firebase Auth user creation
  Future<void> _submit() async {
    ...
    //   Fluttertoast.showToast(
    //     msg: "Please upload a verified image with a visible face.",
    ...
    // Use a try-catch block to handle all asynchronous operations, especially Auth.
    // try {
    // Fluttertoast.showToast(msg: "Registering user...");
    ...
    // } catch (e) {
    //   // General error handling for the entire submission process
    //   Fluttertoast.showToast(
    //     msg: "Error: $e",
    //     backgroundColor: Colors.red,
    //     textColor: Colors.white,
